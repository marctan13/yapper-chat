    ...
    <div className="header">
      <div className="chatAvatar">
        ...
        {!isChannel && members.length === 2 && (
          <img className="chatLogo" src={members.find((member) => member.uid !== user.uid)?.photoURL ? members.find((member) => member.uid !== user.uid)?.photoURL : "/yapper-logo.jpg"} alt="Member image" />
        )}
