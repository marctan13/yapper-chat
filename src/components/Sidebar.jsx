...
import { updateDoc, doc, collection, query, orderBy, onSnapshot, limit } from "firebase/firestore";
        ...
        onSnapshot(
          ...
          (snapshot) => {
            snapshot.docs.map((channelDoc) => {
              ...
              return { id, name, image, lastMessage: null, unsubscribe: onSnapshot(q, (messagesSnapshot) => {
